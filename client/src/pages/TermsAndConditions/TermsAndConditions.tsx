      ...
      <div className="cgu-container">
        <article>
          ...
          <p>
            ...
            objet de définir les conditions d'accès et d'utilisation de
            l'application CityCanvas, une plateforme permettant aux utilisateurs
            de découvrir des œuvres de street art à travers la ville et
            d'ajouter de nouvelles œuvres à la base de données via la
            géolocalisation.
          </p>
          ...
          <p>
            ...
            Certaines fonctionnalités, comme l'ajout d'œuvres, peuvent
            nécessiter la création d'un compte utilisateur.
          </p>
          <h2>3. Inscription et compte utilisateur</h2>
          <p>
            L'inscription sur CityCanvas est facultative pour la consultation
            des œuvres, mais obligatoire pour contribuer à la base de données.
            L'utilisateur s'engage à fournir des informations exactes et à ne
            pas usurper l'identité d'un tiers.
          </p>
          <h2>4. Responsabilités de l'utilisateur</h2>
          <p>
            L'utilisateur s'engage à : Respecter la législation en vigueur et
            les droits des tiers. Ne pas publier de contenus inappropriés,
            offensants ou contraires à l'ordre public. Fournir des informations
            exactes concernant la localisation et les caractéristiques des
            œuvres ajoutées.
          </p>
          ...
          <p>
            ...
            contenu, l'utilisateur accorde à CityCanvas une licence non
            exclusive d'utilisation, de reproduction et de diffusion sur la
            plateforme.
          </p>
          ...
          <p>
            ...
            utilisé à cette fin, conformément à notre politique de protection
            des données.
          </p>
          <h2>7. Responsabilité de l'éditeur</h2>
          <p>
            L'équipe CityCanvas met tout en œuvre pour garantir l'exactitude des
            informations, mais ne saurait être tenue responsable en cas
            d'erreur, omission ou utilisation frauduleuse de la plateforme.
          </p>
          <h2>8. Modification des CGU</h2>
          <p>
            Nous nous réservons le droit de modifier ces CGU à tout moment. Les
            utilisateurs seront informés des changements par tout moyen
            approprié.
          </p>
